...
function out = forces_moments(x, delta, wind, P)
    ...
    Cd  = P.C_D_p+(P.C_L_0+P.C_L_alpha*alpha)^2/(pi*oswald*AR);
    ...
    Cxde= -P.C_D_delta_e*cos(alpha)+P.C_L_delta_e*sin(alpha);
    Cz  = -Cd*sin(alpha)-Cl*cos(alpha);
    Czq = -P.C_D_q*sin(alpha)-P.C_L_q*cos(alpha);
    Czde= -P.C_D_delta_e*sin(alpha)-P.C_L_delta_e*cos(alpha);
