...
% %% convert those values to 5% settling time just for me
% Ts_phugoid = -log(0.05)/(zeta_phugoid*wn_phugoid);
% Ts_short_period = -log(0.05)/(zeta_short_period*wn_short_period);
% Ts_spiral_divergence_mode = -log(0.05)/(zeta_spiral_divergence_mode*wn_spiral_divergence_mode);
% Ts_roll_mode = -log(0.05)/(zeta_roll_mode*wn_roll_mode);
% Ts_dutch_roll_mode = -log(0.05)/(zeta_dutch_roll_mode*wn_dutch_roll_mode);