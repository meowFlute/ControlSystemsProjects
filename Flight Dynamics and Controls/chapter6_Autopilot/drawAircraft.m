...
function drawVehicle(uu,V,F,patchcolors)
    ...
    % at every other time step, redraw base and rod
        ...
        axis(axes_handle, [-graph_size+pe,graph_size+pe,-graph_size+pn,graph_size+pn,-graph_size-pd,graph_size-pd]);
...
V = translate(V, pn, pe, pd);  % translate vehicle
    % this code serves as an example of why you want to rotate before
    % you translate
% V = translate(V, pn, pe, pd);  % translate vehicle
% V = rotate(V, phi, theta, psi);  % rotate vehicle
...
% define faces as a list of vertices numbered above
  F = [...
        % nose (looking from coordinate axis)
        1, 2, 3;...  % top
        1, 3, 4;...  % left
        1, 4, 5;...  % right 
        1, 5, 2;...  % bottom
