...
P.sigma_gyro        = sqrt(gyro_bandwidth)*gyro_noise_density; % standard deviation of error in rad/s
...
%% the guidance model gains
P.b_chidot  = 1.5;
P.b_chi     = 1;
P.b_hdot    = 0.5;
P.b_h       = 1.0;
P.b_Va      = 2.0;
P.gamma_max = 20*pi/180;

%% orbit and line following gains
P.chi_inf = 75*pi/180;
P.k_path  = 0.025;
P.k_orbit = 5;